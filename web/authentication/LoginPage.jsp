...
<!--[if (gte IE 9)|!(IE)]><!--> 	<html lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="form-bg" style="margin-left: 300px;">
            <form method="post" action="loginPage.action">
            ...
            <br>
            <p style="text-align: center; font-weight: bold; font-style: italic"><a href="showRegistration.action">Sign up for a new account</a></p>
        </div> 
        </br></br></br></br> </br></br> 
        <!-- End Document -->
    </body>
