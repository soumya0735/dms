...
if(thisEvent.value=='Submit')
{
  ...
  fields=new Array("user_id","password","confirmpassword","th_area","strTitle","fullname","lname","desig","strDob","emailid","strResearch","strDocpass","strDocConPass");	
  fieldDesc= new Array("User id","Password","Confirm Password","Broad Area","Select Your Title","Full Name","Last Name","Designation","Date Of Birth","Email ID","Research Specialization","Private Key Password ","Confirm Private Key Password ");


}
else
{
   fields=new Array("user_id","password","confirmpassword","th_area","strTitle","fullname","lname","desig","strDob","emailid","strResearch");	
  fieldDesc= new Array("User id","Password","Confirm Password","Broad Area","Select Your Title","First Name","Last Name","Designation","Date Of Birth","Email ID","Research Specialization");
                      ...
                      if(confirmation == true)
                        {
                          ...
                          document.forms[0].action="invDHAction.do";
                          document.forms[0].submit();
                        }
                      else
                          return false;
...
function Cancel(thisEvent)
{
          ...
          location.href="/ICMR/invDHAction.do"; 
