...
(function($, window, document) {
	...
	_oExt.oSort = {
		...
		"date-asc": function ( a, b )
		{
                //alert("first time");
                //     alert(a);
                var xDay=a.substring(0,2);
                var xMon=a.substring(3,5);
                var xYear=a.substring(6,11);
                ...
                var x=new Date();
                   ...
                   x.setMonth(parseInt(xMon-1));
                    x.setFullYear(parseInt(xYear));
       // alert( "a= "+a+"  xDay= "+parseInt(xDay)+"  xmon= "+parseInt(xMon)+" xYear= "+parseInt(xYear));                  
     //alert("a is  "+a+"==  "+x.getTime());
     
                var yDay=b.substring(0,2);
                var yMon=b.substring(3,5);
                var yYear=b.substring(6,11);

                if(yDay.charAt(0)=='0')
                  yDay=yDay.charAt(1);
                if(yMon.charAt(0)=='0')
                  yMon=yMon.charAt(1);
             // alert("b= "+b+"  yDay= "+parseInt(yDay)+"  yMon= "+parseInt(yMon)+" yYear= "+parseInt(yYear));        
                var y=new Date();
                   y.setDate(parseInt(yDay));
                   y.setMonth(parseInt(yMon-1));
                    y.setFullYear(parseInt(yYear)); 
	...
	$.fn.dataTable = function( oInit )
	{
        ...
        var formDiv=document.getElementById('headingofform');
        if(formDiv!=null)
        nInsertNode.appendChild(formDiv);
       /// alert("Before adding br");
				...
				oSettings.aiDisplayMaster.sort( function ( a, b ) {
					...
					for ( i=0 ; i<iSortLen ; i++ )
					{
						iDataSort = aoColumns[ aaSort[i][0] ].iDataSort;
                                                //alert("iDataSort="+iDataSort);
                                                sDataType = aoColumns[ iDataSort ].sType;
                                                
                                                
                                            // var sVarType =_fnDetectType(_fnGetCellData( oSettings, 0, iDataSort, 'type' ));
                                           //  alert("HelloAnsh"+sVarType);
		...
		return this.each(function()
		{
			...
			for ( i=0, iLen=oSettings.aaSorting.length ; i<iLen ; i++ )
			{
				...
				var oColumn ="";
                                oColumn=oSettings.aoColumns[ oSettings.aaSorting[i][0] ];
