...
fields=new Array("user_id","password","confirmpassword","strTitle","fullname","mname","lname","imageFile","desig","orgSTD","orgContactNo","orgExt","mob_no","fax_no","emailid","strDocpass","strDocConPass");	
  fieldDesc= new Array("User id","Password","Confirm Password","Title","First Name","Middle Name","Last Name","User Image","Designation","STD Code","No."," Ext.","Mobile No","Fax No.","Email ID","Private Key Password ","Confirm Private Key Password ");
...
if(thisEvent.value=='Submit')
{
  ...
  fields=new Array("user_id","password","confirmpassword","strTitle","fullname","lname","desig","emailid","strDocpass","strDocConPass");	
  fieldDesc= new Array("User id","Password","Confirm Password","Title","First Name","Last Name","Designation","Email ID","Private Key Password ","Confirm Private Key Password ");


}
else
{
   fields=new Array("user_id","password","confirmpassword","strTitle","fullname","lname","desig","emailid");	
  fieldDesc= new Array("User id","Password","Confirm Password","Title","First Name","Last Name","Designation","Email ID");
  ...
  if(flag1)
    {
      ...
      { 
         ...
         if(stat==false)
           ...
           var status2 = checkoption(thisEvent.value);
           //alert(status2);
           if(status2 == false)
                {
                 return false;
                      ...
                      if(confirmation == true)
                        {
                          ...
                          //document.forms[0].hmode.value="SaveExpert";
                            document.forms[0].hmode.value="SaveDG";
                  ...
                  return false;
                   ...
                   // if(checkContactNo())
                    //{
                      ...
                      if(confirmation == true)
                        {
                          document.forms[0].hmode.value="updateDG";
...
if(resumeFile!="")
 ...
 function checkoption(these)
 {
 //alert("in function");
 if(these=='Submit') 
     {  
    if((document.forms[0].orgSTD.value != "" && document.forms[0].orgContactNo.value != "")|| document.forms[0].mob_no.value != "")
    {
    //alert("in if");
    ...
    alert("Please enter either Office Telephone Number or Mobile Number!!");
    return false;
 }
 }
 }   
...
var url="";
 ...
 if(emailid!= null)
   url="invPOAction.do?hmode=checkEmailID&pEmail="+emailid;		
