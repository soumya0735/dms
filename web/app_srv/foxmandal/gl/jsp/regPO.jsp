...
<%@ page import="java.util.*" %>
 ...
 System.out.println("password=="+daEncoder.decode("bGFsaWdhbQ=="));
    ...
    <script src="/ICMR/app_srv/icmr/gl/jssrc/regPO.js" LANGUAGE="JavaScript" TYPE="text/javascript"></script>
...
<input type="hidden" name="tharea" value="<%=tharea%>" />
 ...
 <input type="HIDDEN" name="strStatusTxt"/>
        ...
        <tr>
	<td>
	&nbsp; Major Discipline<span class="alerttext" >
	*</span></td>
	
	<td >
        <input type="button" id="" value="Add Major Discipline" onclick="functionGetMajorArea(this);"  tabindex="<%=Integer.toString(++iTabIndex)%>" name="majDisp"/> 
        
         <html:hidden  property="majorArea" />
          <html:hidden  property="majorAreaold" />
