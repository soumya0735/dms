...
System.out.println("inside if vijju"+logUserid+":"+userid);
...
%>
     ...
     <div class="whole blue"> 
            <div class="one half align-right">
                 ...
                 <INPUT id="filter" type="text" style="height: 30px;" />
                  <A  hre="#clear" id="clearLink" class="clear-filter" title="clear filter">Clear Filter </A>
                </div>
      </div>
     ...
     <div class="whole align-center ">
      ...
      <section>
       <table class="data footable blue" data-filter="#filter">
        <thead>
         <tr>
          <th></th>
          <%
