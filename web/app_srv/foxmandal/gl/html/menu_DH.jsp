...
{
%>
<a href="/ICMR/divisionHeadhome.do">User Home</a>
<%}%>
  </li>
	<li>
		...
		<ul>
                    <li><a href="/ICMR/viewpodetails.do" title="Program Officer Details">PO List</a></li> 
                    <li><a href="/ICMR/viewExpert.do">Expert List</a></li>
            <li><a href="/ICMR/invDHAction.do?hmode=updateprofile">Update Profile</a></li></ul></li>
